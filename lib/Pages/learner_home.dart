...
class _LearnerHomeScreenState extends State<LearnerHomeScreen> {
  ...
  Widget buildPopularTutors() {
    List<Map<String, dynamic>> displayList =
        searchQuery.isNotEmpty ? searchResults : tutors;
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        Map<String, dynamic> tutorData = displayList[index];
        ...
        return InkWell(
          onTap: () {
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) =>
                    TutorDetailsLearner(tutorData: tutorData),
              ),
            );
          },
          child: Container(
